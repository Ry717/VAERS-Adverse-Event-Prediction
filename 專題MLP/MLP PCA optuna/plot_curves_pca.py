...
ax1.plot(fpr, tpr, color='crimson', lw=2.5, label=f'PCA+MLP (Baseline) (AUC = {roc_auc:.4f})')
...
ax2.plot(recall, precision, color='forestgreen', lw=2.5, label=f'PCA+MLP (Baseline) (AUC-PR = {pr_auc:.4f})')
