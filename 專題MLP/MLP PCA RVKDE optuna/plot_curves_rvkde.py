...
roc_auc = auc(fpr, tpr)
ax1.plot(fpr, tpr, color='crimson', lw=2.5, label=f'RVKDE+MLP (AUC = {roc_auc:.4f})')
...
ax2.plot(recall, precision, color='forestgreen', lw=2.5, label=f'RVKDE+MLP (AUC-PR = {pr_auc:.4f})')
