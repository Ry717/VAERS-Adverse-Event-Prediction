...
output_file = open('svm_pca_optuna_output.txt', 'w', encoding='utf-8-sig')
...
y_pred_best = final_svm_model.predict(X_test)
y_pred_proba_best = final_svm_model.predict_proba(X_test)[:, 1]
...
csv_filename = "svm_pca_aucpr_optuna.csv"
